    ...
    long result;
        ...
        if (a < 0) {
            if (b < 0) {
                ...
                if (numeric_limits<long>::min() - b <= a) {
                    result = a + b;
                } else {
            ...
            if (b < 0) {
                ...
                if (numeric_limits<long>::max() - b >= a) {
                    result = a + b;
                } else {
...
long maths::sum(long arr[], int size) {
...
double maths::sum(double vars[], int size) {
    if (vars == NULL)
        throw maths_exception(string("Null value passed in"));
...
long maths::subtract(long value, long vars[], int size) {
...
double maths::subtract(double value, double vars[], int size) {
...
long maths::multiply(long vars[], int size) {
...
double maths::multiply(double vars[], int size) {
...
double maths::divide(long value, long vars[], int size) {
...
double maths::divide(double value, double vars[], int size) {
...
long maths::power_of(long value, long toThePowersOf[], int size) {
...
double maths::power_of(double value, long toThePowersOf[], int size) {
...
double maths::power_of(double value, double toThePowersOf[], int size) {
...
vector<optional<double>> maths::quadratic(double a, optional<double> b, optional<double> c) {
    ...
    try {
        ...
        auto partOne = -b1;
        auto partTwo = std::pow(safely_subtract(safely_multiply(b1, b1),
...
double maths::hypotenuse(double nearLine, double farLine) {
    ...
    try {
        ...
        result = std::pow(safely_sum(safely_multiply(
