...
namespace GetRealGood.Utils
{
    ...
    public static class Arrays
    {
        ...
        {
            if (Objects.IsNull(o))
                throw new ArraysException("Null parameter passed in for o");
        ...
        if (!coll.Any())
            throw new ArraysException("Empty enumerable passed in for coll");
            ...
            if (iter.MoveNext())
                ...
                throw new ArraysException("Empty collection passed in");
