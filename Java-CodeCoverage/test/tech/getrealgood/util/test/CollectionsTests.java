...
class CollectionsTests {
    ...
    @Test
    void constructor_Collections_Common_Void_Void() {
        try {
            new Collections();
    ...
    class MaxTests {
        ...
        @Test
        void max_Corner_Collection_Object() {
    ...
    class MinTests {
        ...
        @Test
        void min_Common_Collection_Object__1() {
        ...
        @Test
        void min_Corner_Collection_Object() {
    ...
    class PeaksTests {
        ...
        @Test
        void peaks_Common_Collection_Object__1() {
        ...
        @Test
        void peaks_Special_Collection_CollectionsException__2() {

            try {

                var coll = new ArrayList(1);
                coll.add(null);
        ...
        @Test
        void peaks_Corner_Collection_Object() {
    ...
    class TroughsTests {
        ...
        @Test
        void troughs_Common_Collection_Object__1() {
        ...
        @Test
        void troughs_Corner_Collection_Object() {
        ...
        @Test
        void troughs_Special_Collection_CollectionsException__2() {
