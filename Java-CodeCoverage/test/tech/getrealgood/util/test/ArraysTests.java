...
class ArraysTests {
    ...
    @Test
    void constructor_Arrays_Common_Void_Void() {
        try {
            new tech.getrealgood.util.Arrays();
    ...
    class MaxTests {
        ...
        @Test
        void max_Common_Array_Object__1() {

            try {

                var coll = new String[]{"a", "a", "c"};
        ...
        @Test
        void max_Corner_Array_Object() {

            try {

                var coll = new String[]{"a"};
    ...
    class MinTests {
        ...
        @Test
        void min_Common_Array_Object__1() {

            try {

                var coll = new String[]{"c", "c", "a"};
    ...
    class PeaksTests {
        ...
        @Test
        void peaks_Common_Array_Array__1() {

            try {

                var coll = new String[]{"a", "a", "b"};
        ...
        @Test
        void peaks_Common_Array_Array__2() {
    ...
    class TroughsTests {
        ...
        @Test
        void troughs_Common_Array_Array__1() {

            try {

                var coll = new String[]{"b", "b", "a"};
        ...
        @Test
        void troughs_Common_Array_Array__2() {
        ...
        @Test
        void troughs_Corner_Array_Array() {
