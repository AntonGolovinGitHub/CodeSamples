...
class MathsTests {
    ...
    @Test
    void constructor_Maths_Common_Void_Void() {
        try {
            new Maths();
    ...
    class SumTests__1 {
        ...
        @Test
        void sum_Empty_DoubleArray_Double() {
            try {
    ...
    class SubtractTests {
        ...
        @Test
        void subtract_Special_Long_LongArray_Long() {
            try {
                long value = 100;
                long[] values = new long[0];
                assertEquals(100, Maths.subtract(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
    ...
    class SubtractTests__1 {
        ...
        @Test
        void subtract_Special_Double_DoubleArray_Double() {
            try {
                double value = 100d;
                double[] values = null;
                assertThrows(MathsException.class, () -> Maths.subtract(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
        ...
        @Test
        void subtract_Special_Double_DoubleArray_Double__1() {
            try {
                double value = 100d;
                double[] values = new double[0];
                assertEquals(100d, Maths.subtract(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
    ...
    class MultiplyTests {
        ...
        @Test
        void multiply_Exceptional_Long_MathsException() {
            try {
                long[] values = new long[0];
    ...
    class MultiplyTests__1 {
        ...
        @Test
        void multiply_Exceptional_Double_MathsException() {
            try {
                double[] values = new double[0];
    ...
    class DivideTests {
        ...
        @Test
        void divide_Special_Long_Long() {
            try {
                long value = 100l;
                long[] values = null;

                assertEquals(100l, Maths.divide(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
        ...
        @Test
        void divide_Special_Long_Long__1() {
            try {
                long value = 100l;
                long[] values = new long[0];
        ...
        @Test
        void divide_Exceptional_Long_MathsException() {
            try {
                long value = 100l;
                long[] values = new long[] { 10, 0, 100};

                assertThrows(MathsException.class, () -> Maths.divide(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
        ...
        @Test
        void divide_Special_Double_Double() {
            try {
                double value = 100d;
                double[] values = new double[0];

                assertEquals(100d, Maths.divide(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
    ...
    class PowerOfTests {
        ...
        @Test
        void powerOf_Exceptional_Long_LongArray_MathsException__2() {
            try {
                long value = 100l;
                long[] values = new long[0];

                assertThrows(MathsException.class, () -> Maths.powerOf(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
        ...
        @Test
        void powerOf_Exceptional_Long_LongArray_MathsException__3() {
            try {
                long value = 100l;
                long[] values = new long[] { 4, -5, -5, 1000000000, 1000000000, 1000000000} ;
        ...
        @Test
        void powerOf_Exceptional_Long_LongArray_MathsException__4() {
            try {
                long value = -100l;
                long[] values = new long[] { 3, 1000000001, 1000000001, 1000000001} ;
        ...
        @Test
        void powerOf_Special_Long_LongArray_Long__1() {
            try {
                long value = 100l;
                long[] values = new long[] { 4, -5, 2} ;

                assertEquals(100l, Maths.powerOf(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
    ...
    class PowerOfTests__1 {
        ...
        @Test
        void powerOf_Exceptional_Double_LongArray_MathsException__2() {
            try {
                double value = 100d;
                long[] values = new long[0];
        ...
        @Test
        void powerOf_Special_Double_LongArray_Double__1() {
            try {
                double value = 100d;
                long[] values = new long[] {2, 4, 3, -8};

                assertEquals(100d, Maths.powerOf(value, values));
            } catch (Exception ex) {
                fail();
            }
        }
    ...
    class PowerOfTests__2 {
        ...
        @Test
        void powerOf_Exceptional_Double_DoubleArray_MathsException() {
            try {
                double value = 100d;
                double[] values = new double[0];
        ...
        @Test
        void powerOf_Special_Double_DoubleArray_Double() {
            try {
                double value = 100d;
                double[] values = new double[] {2, 4, 3, -8};
